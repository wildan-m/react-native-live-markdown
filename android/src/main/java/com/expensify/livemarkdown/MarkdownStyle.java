...
public class MarkdownStyle {
  ...
  private final String mEmojiFontWeight;

  private final String mEmojiFontStyle;
  ...
  public MarkdownStyle(@NonNull ReadableMap map, @NonNull Context context) {
    ...
    mEmojiFontWeight = parseString(map, "emoji", "fontWeight");
    mEmojiFontStyle = parseString(map, "emoji", "fontStyle");
  ...
  public String getEmojiFontWeight() {
    return mEmojiFontWeight;
  }
  public String getEmojiFontStyle() {
    return mEmojiFontStyle;
  }
